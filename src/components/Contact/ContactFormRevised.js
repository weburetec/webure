...
<div class="inner-common-form">
							...
							<div class="contact-cat">
								<ul>
									<li class=""><a href="#" data-reason="General Inquiries">General Inquiries</a></li>
									...
									<li class="active"><a href="#" data-reason="Careers">Careers</a></li>
								</ul>
							</div>
							<form id="contact-form" method="post" enctype="multipart/form-data">
								<input type="hidden" name="action" value="contact_form_ajax">
								<input type="hidden" name="enquiry_for" id="enquiry_for" value="Careers">
								...
								<div class="row">									
									...
									<div class="form-group col-md-12 field-callback" style="display: none;">
  									...
  									<div class="form-group col-md-12 field-careers" style="">
